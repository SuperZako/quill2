...
namespace Parchment {
    export class ContainerBlot extends ShadowBlot implements Parent {
        ...
        insertBefore(childBlot: Blot, refBlot?: Blot): void {
            if (this.statics.allowedChildren != null && !this.statics.allowedChildren.some(function (child) {
                ...
                throw new ParchmentError(`Cannot insert ${(<ShadowBlot>childBlot).statics.blotName} into ${this.statics.blotName}`);
            }
        ...
        optimize() {
            ...
            if (this.children.length === 0) {
                if (this.statics.defaultChild != null) {
                    let child = create(this.statics.defaultChild);
