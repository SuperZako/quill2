...
namespace Parchment {
    export class ShadowBlot implements Blot {
        ...
        formatAt(index: number, length: number, name: string, value: any): void {
            let blot = this.isolate(index, length);
            if (query(name, Scope.BLOT) != null && value) {
                blot.wrap(name, value);
            } else if (query(name, Scope.ATTRIBUTE) != null) {
                let parent = <Parent & Formattable>create(this.statics.scope);
                blot.wrap(parent);
        ...
        insertAt(index: number, value: string, def?: any): void {
            let blot = (def == null) ? create('text', value) : create(value, def);
        ...
        replaceWith(name: string | Blot, value?: any): Blot {
            let replacement = typeof name === 'string' ? create(name, value) : name;
        ...
        wrap(name: string | Parent, value?: any): Parent {
            let wrapper = typeof name === 'string' ? <Parent>create(name, value) : name;
            if (this.parent != null) {
